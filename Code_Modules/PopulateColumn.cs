...
namespace LynxDrive_ControlSystems_001.Code_Modules
{
    ...
    public class PopulateColumn : ITestModule
    {
...
#region Code Module Variables to access cells and repository
		...
		public string cmStationRowName
		{
			...
			set { 
				_cmStationRowName = value;
				repo.StationRowName = value;
			}
		...
		public string cmStationAccessRow
		{
			...
			set { 
				_cmStationAccessRow = value; 
				repo.StationAccessRow = value;
			}
		}
		...
		public string cmNameRow
		{
			...
			set { 
				_cmNameRow = value;
				repo.NameRow = value;
				//repo.MainForm.CS_StaLevel.rNameRow.Click();
			}
		}
		...
		public string cmAreaRowName
		{
			...
			set { 
				_cmAreaRowName = value; 
				repo.AreaRowName = value;
			}
		}
		...
		public string cmHoleRowName
		{
			...
			set { 
				_cmHoleRowName = value; 
				repo.HoleRowName = value;
			}
		}
		...
		public string cmOffsetRowName
		{
			...
			set { 
				_cmOffsetRowName = value;
				repo.OffsetRowName = value;
			}
		}
...
#region CodeModule Variables to input values
		...
		public string cmNameVal
		{
			...
			set { 
				_cmNameVal = value;
//				repo.MainForm.CS_StaLevel.rNameRow.Click();
//				repo.MainForm.CS_StaLevel.rNameRow.PressKeys(value);			
			}
		}
        ...
        void ITestModule.Run()
        {
            ...
            repo.MainForm.CS_StaLevel.rNameRow.Click();
			repo.MainForm.CS_StaLevel.rNameRow.PressKeys(cmNameVal + downKey + downKey);
			Delay.Ms(tDelay);
			
			repo.MainForm.CS_StaLevel.rAreaRow.Click();
			repo.MainForm.CS_StaLevel.rAreaRow.PressKeys(cmAreaVal);
			Delay.Ms(tDelay);
			
			//hole add in future
//          repo.MainForm.CS_StaLevel.rHoleRow.Click();
//			repo.MainForm.CS_StaLevel.rHoleRow.PressKeys(cmHoelVal);
//			Delay.Ms(500);
			
			//tag add in future
//          repo.MainForm.CS_StaLevel.rTagRow.Click();
//			repo.MainForm.CS_StaLevel.rTagRow.PressKeys(xxx);
//			Delay.Ms(500);

			repo.MainForm.CS_StaLevel.rNOSRow.Click();
			repo.MainForm.CS_StaLevel.rNOSRow.PressKeys(cmNOSVal);
			Delay.Ms(tDelay);		
		
			repo.MainForm.CS_StaLevel.rLSMAddressRow.Click();
			repo.MainForm.CS_StaLevel.rLSMAddressRow.PressKeys(cmAddVal);
			Delay.Ms(tDelay);
			
			repo.MainForm.CS_StaLevel.rLSMOffsetRow.Click();
			repo.MainForm.CS_StaLevel.rLSMOffsetRow.PressKeys(cmOffsetVal);
			Delay.Ms(tDelay);			
			
			repo.MainForm.CS_StaLevel.rWirePathRow.Click();
//			repo.MainForm.CS_StaLevel.rWirePathRow.PressKeys(cmWPValue + downKey + downKey + escapeKey);
			repo.MainForm.CS_StaLevel.rWirePathRow.PressKeys(cmWPValue + retKey + downKey + upKey);
			Delay.Ms(tDelay);
...
//        	LynxDrive_ControlSystems_001Repository repo =  LynxDrive_ControlSystems_001Repository.Instance;
//             
